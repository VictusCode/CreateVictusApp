...
using BooksModule.Features.DeleteBook;
using BooksModule.Features.GetBook;
using BooksModule.Features.GetBooks;
using BooksModule.Features.UpsertBook;
using BooksModule.Infrastructure;
...
public static class BooksModuleConfigurations
{
  ...
  public static IHealthChecksBuilder AddBooksModule(
