...
namespace Core.UnitTests.Repositories
{
  public class EmployeeRepositoryTests
  {
    ...
    public async Task GetOldestAsync_should_return_expected_employee()
    {
      ...
      emp.LastName.Should().NotBeNullOrEmpty().And.Be(theOldest.LastName);
    }
    ...
    public async Task InsertAsync_should_add_and_save(EmployeePostDto employeePostDto)
    {
      ...
      _dbContextMock.Verify(
        x =>
          x.Employees.AddAsync(
            It.Is<Employee>(y => y.LastName == employeePostDto.LastName),
    ...
    [Theory, AutoData]
    public async Task UpdateAsync_should_return_null_when_employee_not_found(
      int empId,
    ...
    [Theory, AutoData]
    public async Task UpdateAsync_should_update_the_entity_and_save_when_employee_found(
      int empId,
      EmployeePutDto employeePutDto
    )
    {
