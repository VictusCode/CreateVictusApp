...
namespace ArchitecturalTests
{
  public class CoreArchitecturalTests
  {
    ...
    {
      var result = _coreTypes.ShouldNot().HaveDependencyOn("Microsoft.AspNetCore").GetResult();
    ...
    public void Repositories_should_not_use_Services()
    {
      var result = _coreTypes
        .That()
        .ResideInNamespace("Core.Repositories")
        .ShouldNot()
        .HaveDependencyOn("Core.Services")
        .GetResult();
    ...
    public void Services_should_have_Service_suffix()
    {
      var result = _coreTypes
        .That()
        .ResideInNamespace("Core.Services")
        .And()
        .AreNotAbstract()
        .Should()
