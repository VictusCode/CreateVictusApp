...
namespace Api.UnitTests.Infrastructure.Filters
{
  public class HttpGlobalExceptionFilterTests
  {
    ...
    public HttpGlobalExceptionFilterTests()
    {
      ...
      _sut = new HttpGlobalExceptionFilter(
        _envMock.Object,
        new Mock<ILogger<HttpGlobalExceptionFilter>>().Object
      );
    }
    ...
    private ExceptionContext GetMockedContext()
    {
      ...
      return new ExceptionContext(actionContext, []) { Exception = new Exception(_exMessage), };
    }
  }
}
