  ...
  public class TestServerClientFixture
  {
    ...
    public TestServerClientFixture()
    {
      var host = new HostBuilder()
        ...
        {
          webBuilder.UseConfiguration(LoadAppConfiguration()).UseStartup<TestStartup>().UseTestServer();
        })
        .Start();
    ...
    {
      return new ConfigurationBuilder().AddJsonFile($"appsettings.Test.json", optional: false).Build();
    }
  }
