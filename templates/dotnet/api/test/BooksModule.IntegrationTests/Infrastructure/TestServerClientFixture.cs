using System.Data;
using BooksModule.IntegrationTests.Infrastructure.DataFeeders;
using Microsoft.AspNetCore.TestHost;
using Microsoft.FeatureManagement;

namespace BooksModule.IntegrationTests.Infrastructure
{
            ...
            .ConfigureServices(services =>
            {
              var config = new ConfigurationBuilder()
                .AddInMemoryCollection(
                  ...
                  {
                    {
                      "ConnectionStrings:SqliteDb",
                      $"Data Source=tests_tempdb_{DateTimeOffset.Now.ToUnixTimeSeconds()}.db"
                    }
                  }
                )
                .Build();
